...
@method_decorator(
    ...
    decorator=swagger_auto_schema(
        ...
        operation_description='Get a list of all Pachyderm import storage connections.',
        manual_parameters=[
            openapi.Parameter(
                name='project',
...
@method_decorator(
    ...
    decorator=swagger_auto_schema(
        ...
        operation_description='Create a new Pachyderm import storage connection.',
    ),
)
...
@method_decorator(
    ...
    decorator=swagger_auto_schema(
        ...
        operation_description='Get a specific Pachyderm import storage connection.',
    ),
)
@method_decorator(
    name='patch',
    decorator=swagger_auto_schema(
        ...
        operation_description='Update a specific Pachyderm import storage connection.',
    ),
)
@method_decorator(
    name='delete',
    decorator=swagger_auto_schema(
        ...
        operation_description='Delete a specific Pachyderm import storage connection.',
    ),
)
...
@method_decorator(
    ...
    decorator=swagger_auto_schema(
        ...
        operation_description='Sync tasks from a Pachyderm import storage connection.',
    ),
)
...
@method_decorator(
    ...
    decorator=swagger_auto_schema(
        ...
        operation_description='Sync tasks from a Pachyderm export storage connection.',
    ),
)
...
@method_decorator(
    ...
    decorator=swagger_auto_schema(
        ...
        operation_description='Validate a specific Pachyderm import storage connection.',
    ),
)
...
@method_decorator(
    ...
    decorator=swagger_auto_schema(
        ...
        operation_description='Validate a specific Pachyderm export storage connection.',
    ),
)
...
@method_decorator(
    ...
    decorator=swagger_auto_schema(
        ...
        operation_description='Get a list of all Pachyderm export storage connections.',
        manual_parameters=[
            openapi.Parameter(
                name='project',
                type=openapi.TYPE_INTEGER,
...
@method_decorator(
    ...
    decorator=swagger_auto_schema(
        ...
        operation_description='Create a new Pachyderm export storage connection to store annotations.',
    ),
)
...
@method_decorator(
    ...
    decorator=swagger_auto_schema(
        ...
        operation_description='Get a specific Pachyderm export storage connection.',
    ),
)
@method_decorator(
    name='patch',
    decorator=swagger_auto_schema(
        ...
        operation_description='Update a specific Pachyderm export storage connection.',
    ),
)
@method_decorator(
    name='delete',
    decorator=swagger_auto_schema(
        ...
        operation_description='Delete a specific Pachyderm export storage connection.',
    ),
)
